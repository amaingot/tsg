...
type AllProps = CustomerTableProps & WithJobsProps & WithStyles;
...
const StyledJobTable = withStyles(styles)(CustomerTable);

export default withJobs<CustomerTableProps>()(StyledJobTable);
